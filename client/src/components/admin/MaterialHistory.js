    ...
    return (
      <div className="container-fluid" >
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 ml-auto weekly-stats mt-4">
        ...
        <div className="row mt-2">
          <div className="col-12">
            ...
            {this.props.admin.addMatEventsMethod === 'month' && (
...
export default connect(mapStateToProps, { getAddMaterialEvents, getAllDisinfectorsAndSubadmins })(withRouter(MaterialHistory));