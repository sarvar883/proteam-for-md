          ...
          <div className="col-lg-4 col-md-6 mt-3">
            <form onSubmit={this.getMonthStats} className="form-bg p-2">
              ...
              <button
                ...
                onClick={() => this.getSpecificMonthStats('current')}
              >
                Этот месяц
              </button>
              ...
              <button
                ...
                onClick={() => this.getSpecificMonthStats('previous')}
              >
                Прошлый месяц
              </button>
            </form>
        ...
        <div className="row mt-2">
          <div className="col-12">
            {this.props.accountant.stats.method === 'week' && (
              <h3 className="text-center pl-3 pr-3">Недельная статистика за <Moment format="DD/MM/YYYY">{this.state.selectedDays[0]}</Moment> - <Moment format="DD/MM/YYYY">{this.state.selectedDays[6]}</Moment></h3>
            )}

            {this.props.accountant.stats.method === 'month' && (
              <h3 className="text-center pl-3 pr-3">Месячная Статистика за {monthsNames[this.state.headingMonth]}, {this.state.headingYear}</h3>
            )}

            {this.props.accountant.stats.method === 'day' && (
              <h3 className="text-center pl-3 pr-3">Дневная Статистика за {this.state.headingDay}</h3>
            )}
          </div>
        </div>
